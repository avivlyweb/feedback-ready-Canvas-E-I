...
export const LogoIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    ...
    <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM6.25 8.5a1.25 1.25 0 112.5 0 1.25 1.25 0 01-2.5 0zm8.25 1.25a1.25 1.25 0 100-2.5 1.25 1.25 0 000 2.5zM12 17.5a4.5 4.5 0 01-4.5-4.5h9a4.5 4.5 0 01-4.5 4.5z" clipRule="evenodd"/>
  </svg>
);

export const ChatBubbleOvalLeftEllipsisIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.761 9.761 0 01-2.542-.381 1.483 1.483 0 00-.97.027c-.529.198-.978.483-1.35.842a2.25 2.25 0 01-3.182-3.182c.359-.372.644-.82.842-1.35.084-.188.14-.386.14-.588V12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" />
    </svg>
);
...
export const DocumentDuplicateIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 01-1.125-1.125v-9.25m9.375 2.25c.621 0 1.125.504 1.125 1.125v3.375m-13.5 0V9.375c0-.621.504-1.125 1.125-1.125h3.375m-1.5-1.5a9.06 9.06 0 013 0m-3 0a9.06 9.06 0 00-3 0m-3 0a9.06 9.06 0 01-3 0m0 0a9.06 9.06 0 00-3 0m12 0a9.06 9.06 0 013 0m0 0a9.06 9.06 0 003 0" />
    </svg>
);
...
export const LockOpenIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 00-9 0v3.75m11.25 11.25h-10.5a2.25 2.25 0 01-2.25-2.25v-6.75a2.25 2.25 0 012.25-2.25H15a2.25 2.25 0 012.25 2.25v6.75a2.25 2.25 0 01-2.25 2.25z" />
...
export const DeviceTabletIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21a3 3 0 003-3h3a3 3 0 003 3M7.5 3a3 3 0 00-3 3v12a3 3 0 003 3h9a3 3 0 003-3V6a3 3 0 00-3-3h-9z" />
    </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l4.5-4.5m-4.5 4.5l-4.5-4.5m12 .001V4.5A2.25 2.25 0 0013.5 2.25h-5.25A2.25 2.25 0 006 4.5v4.992" />
    </svg>
);
...
export const LassoIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M5.312 8.25a3 3 0 012.83-2.336h2.723c.394 0 .783.064 1.15.187 1.34.44 2.288 1.48 2.585 2.854.341 1.578-.3 3.23-1.289 4.492-.99 1.262-2.518 2.03-4.16 2.03h-2.11a3 3 0 01-2.83-2.336L5.312 8.25z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75c2.936 0 5.312-2.015 5.312-4.5 0-2.485-2.376-4.5-5.312-4.5s-5.312 2.015-5.312 4.5c0 2.485 2.376 4.5 5.312 4.5zm0 0a.375.375 0 100-.75.375.375 0 000 .75z" />
  </svg>
);
